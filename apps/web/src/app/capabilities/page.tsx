...
/**
 * Capabilities — who you are, what your designation lets you do, and which
 * projects those powers reach.
 *
 * It used to be the landing page, because in Phase 1 it was the only thing
 * worth showing. It earns its own screen: "why can this officer not see X" is
 * the question support is asked most, and the answer is always on this page —
 * a capability not held, or a project not mapped.
 *
 * Sign in as four officers and it says four different things, which is also
 * the acceptance test for the whole access model.
 */
